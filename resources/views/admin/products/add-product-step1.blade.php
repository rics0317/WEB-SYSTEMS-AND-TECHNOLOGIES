...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nextButton.addEventListener('click', function() {
        if (!nextButton.classList.contains('disabled')) {
            ...
            const url = `{{ route('admin.products.add-product-step2') }}?name=${encodeURIComponent(productName)}&category_id=${categoryId}&sub_category_id=${subCategoryId}&item_id=${itemId}`;
